...
<body class="g-sidenav-show  bg-gray-100">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                <img src="admin/assets/img/team-2.jpg" class="avatar avatar-sm" alt="avatar" />
              </a>
            </li>
          </ul>
        </div>
  ...
  <script src="admin/assets/js/plugins/swiper-bundle.min.js" type="text/javascript"></script>
  <script>
  ...
  <script src="admin/assets/js/corporate-ui-dashboard.min.js?v=1.0.0"></script>
</body>
